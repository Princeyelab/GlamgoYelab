    ...
    <div className={styles.loginPage} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className={styles.container}>
        <div className={styles.formCard}>
          ...
          <div className={styles.badge}>{t('providerLogin.badge')}</div>
          <h1 className={styles.title}>{t('providerLogin.title')}</h1>
          <p className={styles.subtitle}>{t('providerLogin.subtitle')}</p>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.passwordWrapper}>
                <input type={showPassword ? 'text' : 'password'} id='password' name='password' value={formData.password} onChange={handleChange} className={`${styles.input} ${errors.password ? styles.inputError : ''}`} placeholder={t('providerLogin.yourPassword')} autoComplete='current-password' />
          ...
          <div className={styles.footer}>
            <p>{t('providerLogin.noAccount')}{' '}<Link href='/provider/register' className={styles.link}>{t('login.signUp')}</Link></p>
            <p>{t('providerLogin.areClient')}{' '}<Link href='/login' className={styles.link}>{t('providerLogin.clientLogin')}</Link></p>
          </div>
        </div>
      </div>
    </div>
