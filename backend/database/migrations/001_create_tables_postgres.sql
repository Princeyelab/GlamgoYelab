-- =====================================================
-- Base de données GlamGo - PostgreSQL
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_providers_location ON providers(current_latitude, current_longitude);
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    status VARCHAR(20) DEFAULT 'pending' CHECK (status IN ('pending', 'accepted', 'on_way', 'in_progress', 'completed', 'cancelled')),
...
-- Table des bids (système d'enchères)
