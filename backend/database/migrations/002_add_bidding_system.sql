-- =====================================================
-- MIGRATION 002 : SYSTÈME D'ENCHÈRES TYPE INDRIVE
-- =====================================================
-- Date : 2025-11-19
...
-- =====================================================
-- 4. TABLE DES NOTIFICATIONS (SI N'EXISTE PAS)
-- =====================================================
CREATE TABLE IF NOT EXISTS notifications (
    id INT AUTO_INCREMENT PRIMARY KEY,
    recipient_type ENUM('user', 'provider') NOT NULL COMMENT 'Type de destinataire',
    recipient_id INT NOT NULL COMMENT 'ID du destinataire',
    order_id INT NULL COMMENT 'Commande liée (si applicable)',
    notification_type VARCHAR(50) NOT NULL COMMENT 'Type de notification',
    title VARCHAR(255) NOT NULL,
    message TEXT NOT NULL,
    data JSON NULL COMMENT 'Données supplémentaires',
...
COMMENT='Notifications pour utilisateurs et prestataires';

-- =====================================================
-- 5. MODIFICATION DE LA TABLE ORDERS
-- =====================================================
...
SET @sql_user_price = IF(
    @column_exists = 0,
    'ALTER TABLE orders ADD COLUMN user_proposed_price DECIMAL(10, 2) NULL COMMENT ''Budget proposé par utilisateur en mode enchères'' AFTER pricing_mode',
...
SET @sql_accepted_bid = IF(
    @column_exists = 0,
    'ALTER TABLE orders ADD COLUMN accepted_bid_id INT NULL COMMENT ''ID de offre acceptée'' AFTER user_proposed_price',
...
SET @sql_expiry = IF(
    @column_exists = 0,
    'ALTER TABLE orders ADD COLUMN bid_expiry_time TIMESTAMP NULL COMMENT ''Date expiration des offres'' AFTER accepted_bid_id',
...
-- =====================================================
-- 6. MODIFICATION DE LA TABLE SERVICES
-- =====================================================
...
-- =====================================================
-- 7. INITIALISER LES FOURCHETTES DE PRIX POUR LES SERVICES EXISTANTS
-- =====================================================
...
-- =====================================================
-- 8. INITIALISER LES STATS POUR LES PRESTATAIRES EXISTANTS
-- =====================================================
...
-- =====================================================
-- 9. CRÉER DES VUES UTILES (OPTIONNEL)
-- =====================================================
...
-- Afficher un résumé
SELECT
    'Migration 002 exécutée avec succès !' AS message,
